...
//determinar el numero de vocales utilizadas por un usuario en un conjunto de palabras 
//de acuerdo al primer carácter 
/**
 * reporte final 
 * Vocal a - número de veces usada: ? 
 * Vocal e - número de veces usada:?
 * Vocal i - número de veces usada: ? 
 * Vocal o - número de veces usada:?
 * Vocal u- número de veces usada: ?
 */
